...
<div class="reg_div">
    ...
    <ul class="reg_ul">
        ...
        <li>
            <span>原密码：</span>
            <input type="password" name="" value="" placeholder="原密码" class="reg_user" id="password"/>
            <span class="tip user_hint"></span>
        </li>
        <li>
            <span>密码：</span>
        ...
        <li>
            <button type="button" name="button" class="red_button" onclick="Updatepass()">确定修改</button>
        </li>
        <li>
...
<%--<script type="text/javascript" src="jszc/script.js"></script>--%>
